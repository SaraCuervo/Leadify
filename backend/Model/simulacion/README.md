...
> alcanzabilidad del top. Ver [GUIA_TECNICA.md §4.5](../../../GUIA_TECNICA.md).
>
...
> `PESO_LOCALIDAD_CON_BARRIO` en `modelo.py`. Ver [GUIA_TECNICA.md §3.5](../../../GUIA_TECNICA.md).
>
> ```bash
...
debajo del contenido solo. Ver [GUIA_TECNICA.md §4.3](../GUIA_TECNICA.md).
