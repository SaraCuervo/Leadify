...
sigue expandiendo por el grafo de localidades (§3.3 del GUIA_TECNICA.md); el barrio
...
def barrio_desde_coordenadas(lat, lon, localidad=None):
    ...
    sospechosa (el pin de la sala de ventas, ver §6.3 del GUIA_TECNICA.md) y se
